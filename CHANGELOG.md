...
- [multi]Do not delete virtual multi payment methods (bnppirb_multi_Nx) to avoid errors when viewing orders paid with these methods.

2.0.0, 2016-03-10:
- New BNPP IRB payment module for magento 2.
