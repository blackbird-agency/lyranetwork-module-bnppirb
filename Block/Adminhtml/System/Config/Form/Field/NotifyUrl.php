...
/**
 * Custom renderer for the BNPP IRB notify URL.
 */
class NotifyUrl extends Label
{
    ...
    /**
     *
     * @param \Lyranetwork\Bnppirb\Block\Adminhtml\System\Config\Form\Field\Context $context
     * @param array $data
     */
    public function __construct(
        \Lyranetwork\Bnppirb\Block\Adminhtml\System\Config\Form\Field\Context $context,
        array $data = []
    ) {
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        $warnImg = $this->getViewFileUrl('Lyranetwork_Bnppirb::images/warn.png');
