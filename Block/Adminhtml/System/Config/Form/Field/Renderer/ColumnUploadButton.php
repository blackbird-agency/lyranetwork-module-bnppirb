 ...
 * @package   bnppirb
 */
namespace Lyranetwork\Bnppirb\Block\Adminhtml\System\Config\Form\Field\Renderer;
...
class ColumnUploadButton extends \Magento\Framework\View\Element\AbstractBlock
{
    ...
    protected function _toHtml()
    {
        ...
        $src = $this->url->getBaseUrl(UrlInterface::URL_TYPE_MEDIA) . 'bnppirb/gift/<%- logo %>?' . time();
