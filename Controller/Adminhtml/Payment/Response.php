...
class Response extends \Magento\Backend\App\Action implements \Lyranetwork\Bnppirb\Api\ResponseActionInterface
{
    /**
        ...
        if ($this->dataHelper->getCommonConfigData('ctx_mode', $storeId) == 'TEST') {
            ...
            if ($checkUrlWarn) {
                ...
                if ($this->dataHelper->isMaintenanceMode()) {
                    ...
                    $message = __('The automatic validation hasn\'t worked. Have you correctly set up the notification URL in your BNPP IRB Back Office ?');
                    $message .= '<br /><br />';
