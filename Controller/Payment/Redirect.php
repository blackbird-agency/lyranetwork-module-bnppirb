...
use Lyranetwork\Bnppirb\Model\OrderException;

class Redirect extends \Magento\Framework\App\Action\Action implements \Lyranetwork\Bnppirb\Api\RedirectActionInterface
{
    ...
    /**
     *
     * @var \Lyranetwork\Bnppirb\Controller\Processor\RedirectProcessor
     */
     ...
     * @param \Lyranetwork\Bnppirb\Controller\Processor\RedirectProcessor $redirectProcessor
    ...
    public function __construct(
        ...
        \Lyranetwork\Bnppirb\Controller\Processor\RedirectProcessor $redirectProcessor,
    ...
    public function forward()
    {
        ...
        if ($this->getRequest()->getParam('iframe', false)) {
            $resultPage->addHandle('bnppirb_payment_iframe_redirect');
        } else {
            $resultPage->addHandle('bnppirb_payment_form_redirect');
