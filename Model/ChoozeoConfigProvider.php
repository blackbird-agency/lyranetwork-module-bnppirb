...
class ChoozeoConfigProvider extends \Lyranetwork\Bnppirb\Model\BnppirbConfigProvider
{
    ...
    public function __construct(
        ...
        parent::__construct(
            ...
            $paymentHelper,
            $dataHelper,
            \Lyranetwork\Bnppirb\Helper\Data::METHOD_CHOOZEO
        );
    }
    ...
    private function getAvailableOptions()
    {
        ...
        foreach ($this->method->getAvailableOptions($amount) as $key => $option) {
            $card = $option['code'];
            $icon = $this->assetRepo->getUrlWithParams('Lyranetwork_Bnppirb::images/cc/' . strtolower($card). '.png', []);
