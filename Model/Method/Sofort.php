...
class Sofort extends Bnppirb
{

    protected $_code = \Lyranetwork\Bnppirb\Helper\Data::METHOD_SOFORT;

    protected $_formBlockType = \Lyranetwork\Bnppirb\Block\Payment\Form\Sofort::class;

    protected function setExtraFields($order)
    {
        // override with Sofort banking payment card
        $this->bnppirbRequest->set('payment_cards', 'SOFORT_BANKING');
    }
