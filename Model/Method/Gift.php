...
class Gift extends Bnppirb
{

    protected $_code = \Lyranetwork\Bnppirb\Helper\Data::METHOD_GIFT;

    protected $_formBlockType = \Lyranetwork\Bnppirb\Block\Payment\Form\Gift::class;
    ...
    public function assignData(\Magento\Framework\DataObject $data)
    {
        ...
        $info->setCcType($bnppirbData->getData('bnppirb_gift_gc_type'));
