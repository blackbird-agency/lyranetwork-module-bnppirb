 ...
 * @package   bnppirb
 */
namespace Lyranetwork\Bnppirb\Model\System\Config\Backend\Gift;

use Magento\Framework\App\Filesystem\DirectoryList;

class AddedCards extends \Lyranetwork\Bnppirb\Model\System\Config\Backend\Serialized\ArraySerialized\ConfigArraySerialized
{
    ...
    public function beforeSave()
    {
        ...
        foreach ($cards as $key => $card) {
            ...
            $uploadDir = $this->filesystem->getDirectoryWrite(DirectoryList::MEDIA)->getAbsolutePath('bnppirb/gc/');
