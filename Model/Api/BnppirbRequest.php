...
if (! class_exists('BnppirbRequest', false)) {

    /**
     * Class managing and preparing request parameters and HTML rendering of request.
     */
    class BnppirbRequest
    {

        /**
         * The fields to send to the BNPP IRB platform.
         *
         * @var array[string][BnppirbField]
         * @access private
         */
        ...
        {
            // initialize encoding
            $this->encoding = in_array(strtoupper($encoding), BnppirbApi::$SUPPORTED_ENCODINGS) ?
            ...
            $timestamp = time();
            $this->set('vads_trans_id', BnppirbApi::generateTransId($timestamp));
        ...
        {
            $this->requestParameters[$name] = new BnppirbField($name, $label, $regex, $required, $length);
        ...
        /**
         * Generate signature from a list of BnppirbField.
         *
         * @param array[string][BnppirbField] $fields already filtered fields list
         * @param bool $hashed
         * @return string
         */
        private function generateSignature($fields, $hashed = true)
        {
            ...
            return BnppirbApi::sign($params, $this->getCertificate(), $this->algo, $hashed);
        }
         ...
         *
         * @return array[string][BnppirbField] a list of BnppirbField
         */
