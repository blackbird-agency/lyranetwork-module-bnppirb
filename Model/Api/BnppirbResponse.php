...
if (! class_exists('BnppirbResponse', false)) {
    ...
    class BnppirbResponse
    {
         ...
         * @var string
         */
        private $algo = BnppirbApi::ALGO_SHA1;
        ...
        /**
         * Constructor for BnppirbResponse class.
         ...
         * @param string $algo
         */
        public function __construct($params, $ctx_mode, $key_test, $key_prod, $algo = BnppirbApi::ALGO_SHA1)
        {
            $this->rawResponse = BnppirbApi::uncharm($params);
            $this->certificate = trim(($ctx_mode == 'PRODUCTION') ? $key_prod : $key_test);

            if (in_array($algo, BnppirbApi::$SUPPORTED_ALGOS)) {
                $this->algo = $algo;
            }
        ...
        {
            return BnppirbApi::sign($this->rawResponse, $this->certificate, $this->algo, $hashed);
        }
        ...
        /**
         * Check if the payment is to validate manually in the BNPP IRB Back Office.
         * @return bool
         */
        ...
        {
            $currency = BnppirbApi::findCurrencyByNumCode($this->get('currency'));
        ...
        /**
         * @deprecated Deprecated since version 1.2.1. Use <code>BnppirbResponse::getLogMessage()</code>
         * or <code>BnppirbResponse::getMessage()</code> instead.
         */
        ...
        /**
         * @deprecated Deprecated since version 1.2.0. Use <code>BnppirbResponse::getOutputForPlatform()</code> instead.
         */
        ...
        public function getOutputForPlatform($case = '', $extra_message = '', $original_encoding = 'UTF-8')
        {
            ...
            $encoding = in_array(strtoupper($original_encoding), BnppirbApi::$SUPPORTED_ENCODINGS) ?
