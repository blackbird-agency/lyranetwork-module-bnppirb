...
class WsApi extends \SoapClient
{
     ...
     */
    public function __construct(array $options = array(), $wsdl = 'https://e-paiement-securite-bici.com/vads-ws/v5?wsdl')
    {
    ...
    public function getJsessionId()
    {
        ...
        if (!preg_match('#JSESSIONID=([A-Za-z0-9\._]+)#', $header, $matches)) {
            ...
            throw new \SoapFault('BnppirbSID', 'No session ID returned by platform.' . $header);
        }
